// ============================================================
//  WALL-E Base Autonomy Engine
//  Full autonomous navigation with waypoint support
...
enum AutoState {
  ...
  AUTO_TRACK_OBJECT,          // Tracking object with neck + micro eye
  ...
  AUTO_THINK,                 // Pause and "think" (idle reflection)
  AUTO_RETURN_HOME,           // GPS return to base (low battery)
  AUTO_EXPLORE_LOOP,          // Main exploration state
  AUTO_NAVIGATE_WAYPOINT      // GPS waypoint navigation
};

// ============================================================
//  Location State (Compass + GPS + IMU)
// ============================================================
...
struct AutoContext {
  ...
  bool waypointMode;          // True if navigating waypoints
};
...
// Waypoint navigation
#define WAYPOINT_HEADING_TOLERANCE  10.0f   // Degrees
#define WAYPOINT_OBSTACLE_PAUSE_MS  3000    // Pause navigation if obstacle
...
// Returns drive commands: leftSpeed, rightSpeed (-100 to +100)
